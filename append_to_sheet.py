...
# this is the past where we specify what to append and where to append it

# variables - this is the range we will append to, you can decide it by looking at the sheet itself
sheet_range = 'Sheet1!A2:B2'
values = [1,2,3,4,5,'random text','date',6,7,8,9]
...
# NOTICE that everytime we will run it the script will append a new row with the values we stated
print(response)
